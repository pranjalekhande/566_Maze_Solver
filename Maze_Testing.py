...
def visualize_algorithm(loop, maze, algorithm):
    if algorithm == "bfs":
    ...
    # print(str(algorithm).upper(),'------------------------------------',' Trial No.',loop+1)
...
def main():
    ...
    for loop in range(60):
        maze = generate_maze(loop,ROWS, COLS)
        for algorithm_choice in algorithm:
        #     # print(algorithm_choice)
            result = visualize_algorithm(loop, maze, algorithm_choice)
